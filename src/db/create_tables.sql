...
CREATE TABLE IF NOT EXISTS starstrike (id MEDIUMINT NOT NULL AUTO_INCREMENT PRIMARY KEY, perm_id TEXT, teacher TEXT, comment TEXT, title TEXT, icon TEXT, created DATETIME DEFAULT CURRENT_TIMESTAMP, cat INTEGER, isActive BOOLEAN DEFAULT true);
CREATE TABLE IF NOT EXISTS mystarstrike (id MEDIUMINT NOT NULL AUTO_INCREMENT PRIMARY KEY, teacher TEXT, comment TEXT, title TEXT, icon TEXT, created DATETIME DEFAULT CURRENT_TIMESTAMP, cat INTEGER, isActive BOOLEAN DEFAULT true);
